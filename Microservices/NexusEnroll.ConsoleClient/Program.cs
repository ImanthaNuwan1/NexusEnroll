...
namespace NexusEnroll
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Refresh local caches on startup
            facade.RefreshCache();
            ...
            while (!exit)
            {
                ...
                switch (choice)
                {
                    case "1": RunFullAutomatedDemo(facade);     break;
                    case "2": StudentPortal(facade);            break;
                    case "3": FacultyPortal(facade);            break;
                    case "4": AdminPortal(facade);              break;
                    case "5": ViewNotificationHistory(facade);  break;
        ...
        private static void RunFullAutomatedDemo(UniversityFacade facade)
        {
            ...
            Console.Write("\nContinue? (y/n): ");
            if (Console.ReadLine()?.Trim().Equals("n", StringComparison.OrdinalIgnoreCase) == true) return;
            ...
            Console.WriteLine($"  Created student account for STU999");
            ...
            Console.WriteLine($"  Created faculty account for FAC999");
            ...
            Console.WriteLine($"  Created admin account for ADM999");
            ...
            Console.WriteLine("    John Doe (STU001) enrolls in CS201:");
            ...
            Console.WriteLine($"    -> {dropOrRollback(msgD)}");
        ...
        private static string dropOrRollback(string msg)
        {
            return msg;
        }
